...
export default function Footer() {
  return (
    <footer className="pt-10 pb-6 mt-12 border-t">
      <div className="w-full mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        {/* Logo / Title */}
        <div>
      ...
      {/* Divider & Bottom */}
      <div className="mt-10 border-t border-white/30 pt-4 text-center text-sm opacity-80">
